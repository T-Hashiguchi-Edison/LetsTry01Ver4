namespace パソコンデータ入力
{
    partial class Frm顧客伝票ミスチェック
    {
        ...
        private void InitializeComponent()
        {
            ...
            PnlInput = new Panel();
            RtxMailAddress = new RichTextBox();
            RtxTelNo = new RichTextBox();
            RtxItemCd = new RichTextBox();
            RtxCustCd = new RichTextBox();
            BtnSelCan = new Button();
            ...
            LblMailAddress.TabIndex = 14;
            LblMailAddress.Text = "メールアドレス";
            LblMailAddress.TextAlign = ContentAlignment.BottomRight;
            // 
            // PnlInput
            // 
            PnlInput.Controls.Add(RtxMailAddress);
            PnlInput.Controls.Add(RtxTelNo);
            PnlInput.Controls.Add(RtxItemCd);
            PnlInput.Controls.Add(RtxCustCd);
            PnlInput.Controls.Add(BtnSelCan);
            ...
            // RtxMailAddress
            // 
            RtxMailAddress.BackColor = SystemColors.Window;
            RtxMailAddress.Font = new Font("ＭＳ Ｐゴシック", 27.75F, FontStyle.Regular, GraphicsUnit.Point, 128);
            RtxMailAddress.Location = new Point(248, 456);
            RtxMailAddress.Multiline = false;
            RtxMailAddress.Name = "RtxMailAddress";
            RtxMailAddress.ReadOnly = true;
            RtxMailAddress.ScrollBars = RichTextBoxScrollBars.None;
            RtxMailAddress.Size = new Size(584, 48);
            RtxMailAddress.TabIndex = 3;
            RtxMailAddress.Text = "abcdefghij12345678@abcdefghi.ne.jp";
            RtxMailAddress.Enter += RtxMailAddress_Enter;
            // 
            // RtxTelNo
            // 
            RtxTelNo.BackColor = SystemColors.Window;
            RtxTelNo.Font = new Font("ＭＳ Ｐゴシック", 27.75F, FontStyle.Regular, GraphicsUnit.Point, 128);
            RtxTelNo.Location = new Point(248, 376);
            RtxTelNo.Multiline = false;
            RtxTelNo.Name = "RtxTelNo";
            RtxTelNo.ReadOnly = true;
            RtxTelNo.Size = new Size(584, 48);
            RtxTelNo.TabIndex = 2;
            RtxTelNo.Text = "090-0000-0000";
            RtxTelNo.Enter += RtxTelNo_Enter;
            // 
            // RtxItemCd
            // 
            RtxItemCd.BackColor = SystemColors.Window;
            RtxItemCd.Font = new Font("ＭＳ Ｐゴシック", 27.75F, FontStyle.Regular, GraphicsUnit.Point, 128);
            RtxItemCd.Location = new Point(248, 296);
            RtxItemCd.Multiline = false;
            RtxItemCd.Name = "RtxItemCd";
            RtxItemCd.ReadOnly = true;
            RtxItemCd.Size = new Size(584, 48);
            RtxItemCd.TabIndex = 1;
            RtxItemCd.Text = "ABCDEFGHIJKLMNO";
            RtxItemCd.Enter += RtxItemCd_Enter;
            // 
            // RtxCustCd
            // 
            RtxCustCd.BackColor = SystemColors.Window;
            RtxCustCd.Font = new Font("ＭＳ Ｐゴシック", 27.75F, FontStyle.Regular, GraphicsUnit.Point, 128);
            RtxCustCd.Location = new Point(248, 216);
            RtxCustCd.Multiline = false;
            RtxCustCd.Name = "RtxCustCd";
            RtxCustCd.ReadOnly = true;
            RtxCustCd.Size = new Size(584, 48);
            RtxCustCd.TabIndex = 0;
            RtxCustCd.Text = "ABCDEFGHIJ";
            RtxCustCd.Enter += RtxCustCd_Enter;
            // 
            // BtnSelCan
            // 
            BtnSelCan.Font = new Font("ＭＳ Ｐゴシック", 20.25F, FontStyle.Regular, GraphicsUnit.Point, 128);
            BtnSelCan.Location = new Point(438, 544);
            BtnSelCan.Name = "BtnSelCan";
            BtnSelCan.Size = new Size(384, 56);
            BtnSelCan.TabIndex = 5;
            BtnSelCan.Text = "ミスチェック箇所の指摘解除(F2)";
            BtnSelCan.UseVisualStyleBackColor = true;
            BtnSelCan.Click += BtnSelCan_Click;
            // 
            // BtnSelect
            // 
            BtnSelect.Font = new Font("ＭＳ Ｐゴシック", 20.25F, FontStyle.Regular, GraphicsUnit.Point, 128);
            BtnSelect.Location = new Point(32, 544);
            BtnSelect.Name = "BtnSelect";
            BtnSelect.Size = new Size(384, 56);
            BtnSelect.TabIndex = 4;
            BtnSelect.Text = "ミスチェック箇所の指摘(F1)";
        ...
        private Button BtnSelCan;
        private Button BtnSelect;
        private RichTextBox RtxCustCd;
        private RichTextBox RtxMailAddress;
        private RichTextBox RtxTelNo;
        private RichTextBox RtxItemCd;
    }
}
